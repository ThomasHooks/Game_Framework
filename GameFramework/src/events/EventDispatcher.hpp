...
public:
	...
	EventDispatcher() : nextListernerID(0) {}
	...
	{
		if (this->nextListernerID == MAX_LISTENER_ID)
			this->nextListernerID = 0;
...
private:
	...
	{
		CallbackWrapper(Callback<EventType> callable) : callable(callable) {}
